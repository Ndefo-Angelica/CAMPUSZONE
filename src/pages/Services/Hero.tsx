...
const Hero: React.FC = () => {
    ...
    return (
        <section className="relative h-[calc(100vh_-_6rem)] bg-cover bg-center flex " style={{ backgroundImage: "url('/images/Hero.jpg')" }}>
            <div className="absolute inset-0 bg-pink-600 opacity-60"></div>
            <div className="relative max-w-5xl mx-auto  py-40">
                <h1 className="text-4xl md:text-5xl font-bold text-white text-justify leading-tight">Study, practice,<br /><p className="px-20">succeed!!!</p></h1>
