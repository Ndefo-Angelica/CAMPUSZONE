    ...
    <section className="p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div className="border p-4 rounded-lg flex flex-col items-center">
          ...
          <img src="src/assets/Data Quality (2).png" alt="Quality of Content" className="w-12 h-12 my-6" />
        ...
        <div className="border p-4 rounded-lg flex flex-col items-center">
          ...
          <img src="src/assets/Thin Client (1).png" alt="User Experience" className="w-12 h-12  my-6" />
        ...
        <div className="border p-4 rounded-lg flex flex-col items-center">
          ...
          <img src="src/assets/Thin Client (1).png" alt="Expert Guidance" className="w-12 h-12 my-6" />
        ...
        <div className="border p-4 rounded-lg flex flex-col items-center">
          ...
          <img src="src/assets/Thin Client (1).png" alt="Comprehensive Coverage" className="w-12 h-12 my-6" />
